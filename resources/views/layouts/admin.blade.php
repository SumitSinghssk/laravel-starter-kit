...
<x-app>
    ...
    @if (request()->is('admin/login', 'admin/forgot-password', 'admin/reset-password/*', 'admin/two-factor-challenge'))
            ...
            <script defer>
                function initTinyMCE(isDark) {
                    ...
                    tinymce.init({
                        ...
                        content_css: isDark ? 'dark' : '{{ Vite::asset('resources/css/website.css') }}',
